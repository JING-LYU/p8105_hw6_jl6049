...
This distribution of $\log(\hat{\beta}_0 * \hat{\beta}_1)$ is generally normal with mean around 2.02. But the distribution have a little "shoulder" near 2.025. Maybe some large outliers are included in the bootstrap sample.!!!!!!
