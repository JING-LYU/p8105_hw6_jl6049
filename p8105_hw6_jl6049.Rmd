...
Based on the understanding, I `fincme` and `momage`and `menarche` are not relevant. So I try to figure this out by evaluating p values of those variables in a lm model.
```{r}
